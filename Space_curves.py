...
class Space_curves():
    def sierspinski_curve(self,leng=1, iteracions=2, speed=3, origin=(0,0)):
        import turtle
    ...
    def hilbert_curve(self, leng=1, iterac=1,speed=3, origin=(-400,-300)):
        import turtle
        t = turtle.Turtle()
        t.up()
        t.setpos(origin[0], origin[1])
    ...
    def peano_curve(self, leng=1, iterac=1, speed=3,origin=(0,0)):
        import turtle
        t = turtle.Turtle()
        t.speed(speed)
        t.up()
    ...
    def gosper_Flowsnake_curve(self, leng, iterac=1,  speed=3, origin=(0,0)):
        import turtle
        t = turtle.Turtle()
        t.speed(speed)
        t.up()
    ...
    def Pablo_curve(self, len,iterraction, speed=3, origin=(0,0)):
        import turtle
